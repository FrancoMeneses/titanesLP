    ...
    <div>
      ...
      <div id="s1-info-suc1" className="px-5 md:px-10 lg:px-16 text-center flex flex-col justify-center items-center gap-y-6">
        <div className="flex flex-col items-center gap-y-4 lg:flex-row lg:gap-x-8 md:flex-row md:gap-x-4 lg:my-6">
          <p className="text-justify mt-4">Esta sucursal cuenta con la <strong>primera escuela de parkour en Puebla</strong>, el mejor lugar para iniciar y aprender parkour, durante las clases también se les enseñan elementos de acrobacia.
          </p>
        </div>
      </div>
      ...
      <div id="s2-actividades-mini" className="mt-8 px-5 md:px-10 lg:px-16">
        <p className="text-3xl font-semibold text-center mb-6">Actividades en Sucursal 1</p>
        <div id="minigym-suc1" className="my-8">
          <p className="text-2xl font-semibold text-center mb-6">Mini Gym o Mini Parkour</p>
          <p className="text-justify mb-6">Para niños y niñas de <strong>3 a 5 años</strong>, enseñando elementos básicos de parkour y gimnasia,
